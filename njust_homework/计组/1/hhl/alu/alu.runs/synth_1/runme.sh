...
HD_PWD='C:/Users/lenovo/Desktop/hhl/alu/alu.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ALU_led.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ALU_led.tcl
