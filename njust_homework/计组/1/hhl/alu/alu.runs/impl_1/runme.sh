...
HD_PWD='C:/Users/lenovo/Desktop/hhl/alu/alu.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ALU_led.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ALU_led.tcl -notrace
